...
Encore
    ...
    .addEntry('changeCurrentCollectionOnClick', './assets/js/changeCurrentCollectionOnClick.js')
    ...
    .addLoader({
        test: /\.css$/,
        use: [
            { loader: 'postcss-loader', options: { postcssOptions: { config: './postcss.config.js' } } }
        ]
    })
;
